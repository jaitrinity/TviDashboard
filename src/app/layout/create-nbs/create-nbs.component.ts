...
@Component({
  selector: 'app-create-nbs',
  templateUrl: './create-nbs.component.html',
  styleUrls: ['./create-nbs.component.css']
})
export class CreateNbsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // if(this.is_CreateNBS_Tab || this.is_NBS_Sharing_Tab){
      // let commaSepareateTechnologyStr = "";
      // let commaSepareateSiteTypeStr = "";
      ...
      //   if(paramCode == "CreateNBS_Tab_Technology"){
      //     commaSepareateTechnologyStr = paramDesc;
      //   }
      //   else if(paramCode == "CreateNBS_Tab_SiteType"){
      //     commaSepareateSiteTypeStr = paramDesc;
      //   }
      // }

      // this.technologyList = this.createArrFromCommasepareateStr(commaSepareateTechnologyStr);
      // this.siteTypeList = this.createArrFromCommasepareateStr(commaSepareateSiteTypeStr);
    ...
    //   this.siteTypeList = [{"paramCode":"In lieu of GBT/RTT","paramDesc":"In lieu of GBT/RTT "},
    //   {"paramCode":"Standalone COW","paramDesc":"Standalone COW "}];
    // }
    ...
    //this.stateList = [{"paramCode":"A","paramDesc":"A "},{"paramCode":"B","paramDesc":"B "}];

    //this.districtList = [{"paramCode":"A","paramDesc":"A "},{"paramCode":"B","paramDesc":"B "}];
    ...
    // this.opcoFrequencyList = [{"paramCode":"900","paramDesc":"900 "},
    // {"paramCode":"1800","paramDesc":"1800 "},
    // {"paramCode":"2100","paramDesc":"2100 "},
    // {"paramCode":"2300","paramDesc":"2300 "},
    // {"paramCode":"2500","paramDesc":"2500 "}];
    ...
    //     id : i
    //   }
    //   this.noOfGSMAntennaList.push(json)
    // }
  ...
  refreshPage(){
    this.route.navigateByUrl('/layout/dashbord', { skipLocationChange: true }).then(() => {
      this.route.navigate(['/layout/create-nbs']);
    }); 
  }
  ...
  getNoOfList(){
    this.allNoOfList = JSON.parse(localStorage.getItem("allNoOfList"));
      ...
      for(let i=0;i<this.allNoOfList.length;i++){
        ...
        else if(paramCode == "CreateNBS_Tab_Technology"){
      ...
      this.spinner.hide(); 
       //console.log(response);
         if(response.responseCode === Constant.SUCCESSFUL_STATUS_CODE){
          ...
          let msg = "SR already exist on given `Latitude 1` = '"+this.latitude1+"' and `Longitude 1` = '"+this.longitude1+"' or  ";
          msg += "`"+this.operator+" Site Id` = '"+this.airtelSiteId+"'.";
